...
class Player(_object):
    ...
    def __init__(self, base):
        this = _Player.new_Player(base)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _Player.delete_Player
    __del__ = lambda self: None

    def GetName(self, refresh=False):
        return _Player.Player_GetName(self, refresh)
Player_swigregister = _Player.Player_swigregister
